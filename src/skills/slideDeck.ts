...
export const SLIDE_PRESETS: SkillOption[] = [
  ...
  { id: 'editorial-infographic', name: 'Editorial Infographic', name_zh: '編輯信息圖', desc: '雜誌說明的多圖佈局與圖說。資訊豐富', promptModifier: 'Editorial Infographic style. Light gray background, bold serif headlines, multi-section layouts, icon data visualizations.' },

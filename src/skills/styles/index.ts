...
import neubrutalismMd from './neubrutalism.md?raw';
import vaporwaveMd from './vaporwave.md?raw';
import risographMd from './risograph.md?raw';
import duotoneMd from './duotone.md?raw';
import paper_cutoutMd from './paper-cutout.md?raw';
...
export const VISUAL_STYLE_TEMPLATES: VisualStyleTemplate[] = [
    ...
    {
        id: 'ikea-manual',
        name: 'IKEA Manual — Flat Schematic',
        name_zh: 'IKEA 說明書風',
        category: 'Specialized',
        description: 'Minimal line art assembly instructions with universal visual indicators.',
        description_zh: '極簡線條畫組裝說明，帶有通用視覺指標。',

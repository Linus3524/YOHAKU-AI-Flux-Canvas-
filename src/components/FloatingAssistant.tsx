...
const FEATURE_DOCS = [
  ...
  {
    category: "5. 圖層管理 (Layer Management)",
    items: [
      { title: "圖層面板", desc: "支援拖曳排序、隱藏/顯示、鎖定/解鎖、重新命名、刪除。" },
      { title: "群組/解散", desc: "將多個物件綁定在一起移動或操作 (Ctrl + G)。" },
      { title: "合併圖層", desc: "將選取的多個物件「壓平」為一張 PNG 圖片，自動裁切透明邊界並使用 3x 高清渲染。" }
    ]
  },
  {
    category: "6. 系統功能 (System)",
    items: [
      { title: "轉換為圖片 (Rasterize)", desc: "對文字、形狀、箭頭點擊優鍵轉換。系統採用 3 倍超取樣 (Super-Sampling)，確保在大螢幕上清晰銳利。" },
      { title: "復原/重做", desc: "完整的歷史記錄支援，包含繪圖步驟與物件操作。" },
      { title: "匯出/匯入", desc: "支援將畫布匯出為 JSON 備份，或匯入還原工作區。" }
    ]
  },
  {
    category: "7. 常用快捷鍵 (Shortcuts)",
    items: [

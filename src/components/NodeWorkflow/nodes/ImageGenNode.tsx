...
const MODEL_OPTIONS = ['gemini', 'seedream-v5-pro', 'seedream-v5', 'seedream-v4.5', 'gpt-image-2', 'gpt-image-2.5-sunburst', 'gpt-image-2.5-flare', 'flux-2-pro'];
...
export function ImageGenNode({ id, data, selected }: NodeProps) {
  ...
  const params = (data?.params ?? {}) as Partial<ImageGenParams & { isCollapsed?: boolean }>;
